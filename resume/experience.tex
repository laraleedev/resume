  ...
  \cventry
    ...
    {Nov. 2018 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		\item {Main developer for major framework updates and refactors such as breaking core dependency updates or docker/cicd updates. Drove and implemented linting/prettier/commit-linting, alongside jsdoc standardization. Converted entire frontend framework to Typescript for stricter code standards. }
